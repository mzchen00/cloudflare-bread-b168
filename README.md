...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/cloudflare-bread-b168#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/cloudflare-bread-b168
```

A live public deployment of this template is available at [https://cloudflare-bread-b168.templates.workers.dev](https://cloudflare-bread-b168.templates.workers.dev)
